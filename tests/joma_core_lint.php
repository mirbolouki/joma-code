...
foreach (['joma-core/domain_rules.php','joma-core/db.php','joma-core/session.php','joma-core/auth.php','joma-core/context.php','joma-core/acceptance.php','joma-core/hold.php','joma-core/portal.php','joma-core/receipt.php','joma-core/audit.php','tests/joma_domain_rules.php','tests/joma_core_adapters.php','tests/joma_core_acceptance.php','tests/joma_core_hold.php','tests/joma_core_portal.php','tests/joma_core_receipt_audit.php','tests/joma_core_lint.php'] as $path) {
