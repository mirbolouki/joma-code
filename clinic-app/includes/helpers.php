...
// Cookie-only sessions: never expose session identifiers in links or forms.
function joma_needs_sid() {return false;}
function joma_append_sid($url) {return $url;}
function joma_sid_field() {return '';}
